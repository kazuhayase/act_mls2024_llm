...
- 🎯 Entry points to execute your program using `python -m <act_mls2024_llm>` or `$ act_mls2024_llm` with basic CLI argument parsing.
...
[![codecov](https://codecov.io/gh/kazuhayase/act_mls2024_llm/branch/main/graph/badge.svg?token=act_mls2024_llm_token_here)](https://codecov.io/gh/kazuhayase/act_mls2024_llm)
[![CI](https://github.com/kazuhayase/act_mls2024_llm/actions/workflows/main.yml/badge.svg)](https://github.com/kazuhayase/act_mls2024_llm/actions/workflows/main.yml)

Awesome act_mls2024_llm created by kazuhayase

## Install

from source
```bash
git clone https://github.com/kazuhayase/act_mls2024_llm act_mls2024_llm
cd act_mls2024_llm
make install
```
...
```bash
pip install act_mls2024_llm
```

## Executing

```bash
$ act_mls2024_llm run --port 8080
```

or

```bash
python -m act_mls2024_llm run --port 8080
```

or

```bash
$ uvicorn act_mls2024_llm:app
```

## CLI

```bash
❯ act_mls2024_llm --help
Usage: act_mls2024_llm [OPTIONS] COMMAND [ARGS]...
...
```bash
❯ act_mls2024_llm create-user --help
Usage: act_mls2024_llm create-user [OPTIONS] USERNAME PASSWORD
...
```bash
act_mls2024_llm create-user admin admin --superuser
```
...
Run with `act_mls2024_llm run` and access http://127.0.0.1:8000/docs

![](https://raw.githubusercontent.com/rochacbruno/fastapi-project-template/master/docs/api.png)


**For some api calls you must authenticate** using the user created with `act_mls2024_llm create-user`.
...
-----------------------------------------------------
act_mls2024_llm/__init__.py              4      0   100%
act_mls2024_llm/app.py                  16      1    94%
act_mls2024_llm/cli.py                  21      0   100%
act_mls2024_llm/config.py                5      0   100%
act_mls2024_llm/db.py                   10      0   100%
act_mls2024_llm/models/__init__.py       0      0   100%
act_mls2024_llm/models/content.py       47      1    98%
act_mls2024_llm/routes/__init__.py      11      0   100%
act_mls2024_llm/routes/content.py       52     25    52%
act_mls2024_llm/routes/security.py      15      1    93%
act_mls2024_llm/routes/user.py          52     26    50%
act_mls2024_llm/security.py            103     12    88%
-----------------------------------------------------
TOTAL                               336     66    80%
...
> `dynaconf_merge` is a boolean that tells if the settings should be merged with the default settings defined in act_mls2024_llm/default.toml.
